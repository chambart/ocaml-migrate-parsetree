...
and copy_typ : Ast_409.Parsetree.typ -> Ast_410.Parsetree.typ =
  fun x -> copy_core_type x
and copy_pat : Ast_409.Parsetree.pat -> Ast_410.Parsetree.pat =
  fun x -> copy_pattern x
and copy_expr : Ast_409.Parsetree.expr -> Ast_410.Parsetree.expr =
...
and copy_cases : Ast_409.Parsetree.cases -> Ast_410.Parsetree.cases =
...
and copy_pattern_desc :
  ...
  | Ast_409.Parsetree.Ppat_unpack x0 ->
      Ast_410.Parsetree.Ppat_unpack (copy_loc (fun x -> x) x0)
...
and copy_module_binding :
  ...
  fun
    ...
    ->
    {
      Ast_410.Parsetree.pmb_name = (copy_loc (fun x -> x) pmb_name);
...
and copy_module_declaration :
  ...
  fun
    ...
    ->
    {
      Ast_410.Parsetree.pmd_name = (copy_loc (fun x -> x) pmd_name);
