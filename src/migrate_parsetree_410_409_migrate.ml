...
and copy_out_module_type :
  ...
  | Ast_410.Outcometree.Omty_functor (x0, x1, x2) ->
...
and copy_typ : Ast_410.Parsetree.typ -> Ast_409.Parsetree.typ =
  fun x -> copy_core_type x
and copy_pat : Ast_410.Parsetree.pat -> Ast_409.Parsetree.pat =
  fun x -> copy_pattern x
and copy_expr : Ast_410.Parsetree.expr -> Ast_409.Parsetree.expr =
...
and copy_cases : Ast_410.Parsetree.cases -> Ast_409.Parsetree.cases =
...
and copy_module_expr_desc :
  ...
  | Ast_410.Parsetree.Pmod_functor (x0, x1, x2) ->
...
and copy_module_type_desc :
  ...
  | Ast_410.Parsetree.Pmty_functor (x0, x1, x2) ->
